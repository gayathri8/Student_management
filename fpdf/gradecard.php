...
while($cand = mysql_fetch_array($list_can)){
	...
	$q1 = "select first_name, middle_name, last_name, enrollment_no, program_id from student where student_id = '".$cand[0]."'";
	$q3 = "select course_id "

		$q = "select * from grade where student_id = '".$cand[0]."'";
