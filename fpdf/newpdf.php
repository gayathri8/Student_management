...
$link = $cnx_id; 
$list_can=mysql_query('select distinct student_id from new', $link);
...
while($cand = mysql_fetch_array($list_can)){
	//echo $cand;
	$q = "select * from new where student_id = '".$cand[0]."'";
