...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (isset($_POST["registered_email"])) {
		...
		$student_id = get_val('student_original', 'comm_email', $registered_email, 'student_id');
		if ($student_id) {
		...
		$student_id = get_val('student_original', 'comm_email', $email, 'student_id');
...
$query_program = "SELECT program_id, program_name FROM program where program_type = '" . $type . "'";
